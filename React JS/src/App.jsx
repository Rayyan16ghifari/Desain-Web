  ...
  return (
    <div className=" text-white">
      <div className=" justify-center items-center grid space-y-5 mt-52">
         <p className=" text-center">Extension Creator <a href="https://www.instagram.com/rayyan_ghfr /x" className=" duration-200 hover:text-purple-500">Muhammad Rayyan Ghifari</a></p>
